...
class RCCar:
    ...
    def rotateLegs(self, x_q):#x_q determines rotation of wheels
        ...
        if(x_q >= 0):#counterclockwise
            ...
            angle_to_rot_front = min([max_angle_to_rot1, max_angle_to_rot2])
            angle_to_rot_back = min([max_angle_to_rot3, max_angle_to_rot4])
            dist_rot_causes1 = DistanceSweptOutBetweenAngles(self.Leg1.angle, self.Leg1.angle - self.Leg1.direction*angle_to_rot_front)
            dist_rot_causes2 = DistanceSweptOutBetweenAngles(self.Leg2.angle, self.Leg2.angle - self.Leg2.direction*angle_to_rot_front)
            dist_rot_causes3 = DistanceSweptOutBetweenAngles(self.Leg3.angle, self.Leg3.angle - self.Leg3.direction*angle_to_rot_back)
            dist_rot_causes4 = DistanceSweptOutBetweenAngles(self.Leg4.angle, self.Leg4.angle - self.Leg4.direction*angle_to_rot_back)
